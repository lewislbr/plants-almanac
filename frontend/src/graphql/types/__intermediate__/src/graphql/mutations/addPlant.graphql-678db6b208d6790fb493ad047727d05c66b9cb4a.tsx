...
export type AddPlantComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<AddPlantMutation, AddPlantMutationVariables>, 'mutation'>;
    ...
    export const AddPlantComponent = (props: AddPlantComponentProps) => (
      <ApolloReactComponents.Mutation<AddPlantMutation, AddPlantMutationVariables> mutation={AddPlantDocument} {...props} />
    );
