declare module '*/getPlant.graphql' {
  ...
  export const GetPlantDocument: import("graphql").DocumentNode;
  export type GetPlantComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetPlantQuery, GetPlantQueryVariables>, 'query'> & ({
      variables: GetPlantQueryVariables;
      skip?: boolean;
  } | {
      skip: boolean;
  });
  export const GetPlantComponent: (props: GetPlantComponentProps) => JSX.Element;
  /**
   ...
   * });
   */
  export function useGetPlantQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetPlantQuery, GetPlantQueryVariables>): ApolloReactCommon.QueryResult<GetPlantQuery, GetPlantQueryVariables>;
  export function useGetPlantLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetPlantQuery, GetPlantQueryVariables>): ApolloReactHooks.QueryTuple<GetPlantQuery, GetPlantQueryVariables>;
