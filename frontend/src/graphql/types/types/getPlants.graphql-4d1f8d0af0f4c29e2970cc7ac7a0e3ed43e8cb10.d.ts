declare module '*/getPlants.graphql' {
  ...
  export const GetPlantsDocument: import("graphql").DocumentNode;
  ...
  export const GetPlantsComponent: (props: Pick<ApolloReactComponents.QueryComponentOptions<GetPlantsQuery, GetPlantsQueryVariables>, "client" | "children" | "displayName" | "variables" | "skip" | "onCompleted" | "onError" | "ssr" | "fetchPolicy" | "errorPolicy" | "pollInterval" | "notifyOnNetworkStatusChange" | "context" | "partialRefetch" | "returnPartialData">) => JSX.Element;
  /**
   ...
   * });
   */
  export function useGetPlantsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetPlantsQuery, GetPlantsQueryVariables>): ApolloReactCommon.QueryResult<GetPlantsQuery, GetPlantsQueryVariables>;
  export function useGetPlantsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetPlantsQuery, GetPlantsQueryVariables>): ApolloReactHooks.QueryTuple<GetPlantsQuery, GetPlantsQueryVariables>;
